        ...
        <section className="py-16 px-6 max-w-[760px] mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex gap-5 items-start">
              <div className="w-11 h-11 rounded-full bg-[#3ddc84] text-[#080d1a] flex items-center justify-center flex-shrink-0 font-condensed font-black text-lg">1</div>
              <div>
                <div className="font-condensed font-bold text-lg text-white mb-1">You add your name</div>
                <div className="text-gray-400 text-sm">Not symbolic. Not a petition that disappears. It's how real people are counted — by district.</div>
              </div>
            </div>
            <div className="flex gap-5 items-start">
              <div className="w-11 h-11 rounded-full bg-[#3ddc84] text-[#080d1a] flex items-center justify-center flex-shrink-0 font-condensed font-black text-lg">2</div>
              <div>
                <div className="font-condensed font-bold text-lg text-white mb-1">We organize by district</div>
                <div className="text-gray-400 text-sm">Your name becomes part of a coordinated pressure block tied directly to your representative — based on what people in your district actually want.</div>
              </div>
            </div>
            <div className="flex gap-5 items-start">
              <div className="w-11 h-11 rounded-full bg-[#3ddc84] text-[#080d1a] flex items-center justify-center flex-shrink-0 font-condensed font-black text-lg">3</div>
              <div>
                <div className="font-condensed font-bold text-lg text-white mb-1">When enough people are organized</div>
                <div className="text-gray-400 text-sm">The pressure becomes public and visible inside the district — creating a moment where your representative has to respond, in front of the people they represent.</div>
              </div>
            </div>
            <div className="flex gap-5 items-start">
              <div className="w-11 h-11 rounded-full bg-red-600 text-white flex items-center justify-center flex-shrink-0 font-condensed font-black text-lg">4</div>
              <div>
                <div className="font-condensed font-bold text-lg text-red-500 mb-1">And when leaders ignore it</div>
                <div className="text-gray-400 text-sm">They either respond — or they have to explain why they won't, publicly, on the record.</div>
              </div>
            </div>
          </div>

    ...
    <>
      ...
      <main className="pt-20 pb-16 max-w-[860px] mx-auto px-6">
        ...
        <div className="text-center mb-8">
          ...
          <span className="font-condensed font-bold text-red-500 text-sm uppercase tracking-wide">This Is What Existential Looks Like</span>
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-white mt-3 mb-4">The 5D Crisis.<br /><span className="text-red-500">One Spiral.</span> <span className="text-[#3ddc84]">One Way Out.</span></h1>
          <p className="text-gray-400 max-w-[680px] mx-auto">Five dimensions. One system. Every piece feeding the others — each failure making the next one worse. That's why nothing ever gets fixed. And that's exactly what PHIERS was built to interrupt.</p>
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            ...
            <Link href="/simple-math" className="px-6 py-3 bg-transparent text-[#3ddc84] border border-[#3ddc84] rounded-lg font-condensed font-bold hover:bg-[#3ddc84]/10 transition-all">→ See the Math</Link>
          </div>
        </div>
        ...
        {/* INTRO */}
        <div className="text-center mb-8">
          <p className="text-gray-400 max-w-[720px] mx-auto">We've been taught to think about these as separate problems — each with its own experts, its own advocates, its own hashtag. Healthcare people work on healthcare. Peace people work on peace. Labor people work on labor.</p>
          <p className="text-white font-semibold text-lg mt-6 max-w-[720px] mx-auto">That's exactly why nothing gets fixed.</p>
          <p className="text-gray-400 mt-4 max-w-[720px] mx-auto">These aren't separate problems. They're one system. And right now every dimension of that system is at or near a breaking point — simultaneously. That's not politics. That's not hyperbole. That's the situation. Here's how it actually works.</p>
        </div>
        ...
        {/* DIMENSION 1: WAR */}
        <div className="mb-12">
          <span className="font-condensed font-bold text-red-500 text-sm uppercase tracking-wide">Dimension 1</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-2">🔥 War — <span className="text-red-500">The Front Edge</span></h2>
          <p className="font-condensed font-bold text-gray-500 text-sm mb-6">What has to stop first</p>
          ...
          <p className="text-white font-semibold mb-6">This is not a foreign policy story. It's a kitchen table story. A medicine cabinet story. A "how do I pay this month's bills" story.</p>

          <h3 className="font-condensed font-bold text-[#ffd60a] text-xl mt-6 mb-3">Two Sets of Laws Say No.</h3>
          <p className="text-gray-400 mb-3">The Constitution is clear: Congress declares war. Article I, Section 8. The President commands the military — Congress authorizes its use. That separation exists because the people who send others to war should be the people most directly accountable to those doing the dying.</p>
          <p className="text-gray-400 mb-3">What fewer people know is there's a second wall. The United Nations Charter — the framework America championed after World War II — also says no. Article 2(4) prohibits the threat or use of force against another nation's territorial integrity. Article 25 obligates member states to act in accordance with Security Council decisions.</p>
          ...
          <div className="bg-[#ffd60a]/10 border-l-4 border-[#ffd60a] rounded-r-lg p-5 my-6">
            <p className="font-condensed font-bold text-[#ffd60a] mb-2">The downstream risk is real.</p>
            <p className="text-gray-400">When wars escalate without congressional authorization, without exit strategies, without public mandates — pressure to expand the fighting force builds. History is consistent on this. The people who bear that cost are the ones who had no vote in creating it. The only way to stop it is organized people — before it happens, not after.</p>
          </div>

          <p className="text-right"><Link href="/no-war" className="text-red-500 font-condensed font-bold text-sm">→ Full breakdown: No War / No Draft page</Link></p>
        </div>
        ...
        <div className="mb-12">
          <span className="font-condensed font-bold text-[#3ddc84] text-sm uppercase tracking-wide">Dimension 2</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-4">💊 Healthcare — <span className="text-red-500">The Largest Structural Inefficiency in the American Economy</span></h2>
          <p className="text-gray-400 mb-6">CMS — the federal agency that administers Medicare and Medicaid — pays roughly $8,000 per person per year under traditional insurance models. Research consistently shows that approximately 80% of everyday healthcare needs can be met through telehealth and preventative care at roughly $600 per person per year.</p>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-6">
            <div className="bg-[#111d35] border border-red-500/30 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-red-500">$8,000</div>
              <p className="text-gray-500 text-sm">What CMS pays per person under traditional insurance — every year</p>
            </div>
            <div className="bg-[#111d35] border border-red-500/30 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-red-500">$600</div>
              <p className="text-gray-500 text-sm">What 80% of people actually need — telehealth, prevention, affordable care</p>
            </div>
            <div className="bg-[#111d35] border border-red-500/30 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-[#3ddc84]">$7,400</div>
              <p className="text-gray-500 text-sm">Freed per person, per year — redirected from overhead to people</p>
            </div>
          </div>

          <p className="text-gray-400 mb-3">That gap — $7,400 per person, per year — multiplied across the American population represents <strong className="text-[#3ddc84]">$2.73 trillion annually</strong>. Not profit from providing care. Overhead, administrative cost, and margin extracted by a system designed around payment processing rather than health outcomes.</p>
          <p className="text-gray-400 mb-3">The $600 telehealth model covers approximately 80% of healthcare needs — not 100%. Emergencies, complex procedures, and acute care still require the full system. But 80% of what people actually need, they need regularly, predictably, and affordably. That's the part that's broken. That's the part PHIERS fixes first. And that's the part that funds everything inside this ring.</p>
          ...
          <p className="text-right"><Link href="/simple-math" className="text-[#3ddc84] font-condensed font-bold text-sm">→ See the Simple Math</Link></p>
        </div>
        ...
        {/* DIMENSION 3: ECONOMY */}
        <div className="mb-12">
          <span className="font-condensed font-bold text-[#3ddc84] text-sm uppercase tracking-wide">Dimension 3</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-4">🔨 Economy &amp; Jobs — <span className="text-red-500">The Floor Is Gone</span></h2>
          <p className="text-gray-400 mb-3">Real wages in America have been effectively flat for decades — not because workers became less productive, but because the gains from their productivity went somewhere else. That's documented in federal wage and productivity data going back to the 1970s.</p>
          ...
          <div className="bg-[#3ddc84]/10 border-l-4 border-[#3ddc84] rounded-r-lg p-5 my-6">
            <p className="font-condensed font-bold text-[#3ddc84] text-lg mb-2">12 million jobs. Built from savings, not promises.</p>
            <p className="text-gray-400">Every $7,400 freed per person per year is capital that stays in the community instead of flowing to shareholders. Every telehealth navigator is a living-wage job. Every cooperative hub is a local employer. Every community health worker is a union-eligible role in a district that needs it. Funded directly from the savings. In the communities where the savings happen. The moment the conversion begins.</p>
          </div>

          <p className="text-gray-400 mb-4">PHIERWorks is the employment engine inside the healthcare engine. One powers the other. Both are powered by the organized constituent leverage in Ring 1.</p>
          <p className="text-right"><Link href="/solutions" className="text-[#3ddc84] font-condensed font-bold text-sm">→ See 5D Solutions</Link></p>
        </div>
        ...
        <div className="mb-12">
          <span className="font-condensed font-bold text-[#3ddc84] text-sm uppercase tracking-wide">Dimension 4</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-4">⚖️ Politics — <span className="text-red-500">They Ignore You Because They Can</span></h2>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-6">
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-red-500">12%</div>
              <p className="text-gray-500 text-sm">Congressional approval rating</p>
            </div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-red-500">92%</div>
              <p className="text-gray-500 text-sm">Congressional reelection rate</p>
            </div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-[#3ddc84]">3.5%</div>
              <p className="text-gray-500 text-sm">Participation threshold that forces change — every time</p>
            </div>
          </div>

          <p className="text-gray-400 mb-3">That 12% vs 92% gap isn't dysfunction. It's a system working exactly as designed — for the people inside it, not the people it's supposed to represent.</p>
          <p className="text-gray-400 mb-3">Protests don't change it. Hashtags don't change it. Petitions without electoral consequences don't change it. The only thing that reliably changes a politician's behavior is organized people in their specific district — names on the record, verified by zip code, with documented intent to vote accordingly.</p>
          <p className="text-gray-400 mb-3">Harvard researcher Erica Chenoweth's analysis of 323 civic campaigns across a century of political history found that movements achieving and sustaining 3.5% participation succeeded in creating significant political change — every time. That's 12 million Americans organized by district, names on the record, with teeth.</p>
          <p className="text-white font-semibold mb-4">The same lever that forces action on healthcare forces action on war powers. You don't build separate movements. You build one movement with enough organized mass to move everything.</p>
          <p className="text-right"><Link href="/leverage" className="text-[#3ddc84] font-condensed font-bold text-sm">→ See the Leverage</Link></p>
        </div>
        ...
        {/* DIMENSION 5: PEACE */}
        <div className="mb-12">
          <span className="font-condensed font-bold text-[#3ddc84] text-sm uppercase tracking-wide">Dimension 5</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-4">✊ Peace — <span className="text-[#3ddc84]">Not a Position. A Prerequisite.</span></h2>
          <p className="text-gray-400 mb-3">Peace isn't naive. Peace isn't a bumper sticker. Peace is the precondition for everything else on this list.</p>
          <p className="text-gray-400 mb-3">You cannot redirect $2.73 trillion from insurance overhead to people if the economy is in freefall because military escalation just spread across every supply chain. You cannot build 12 million living-wage jobs if the workforce is being drawn into military service. You cannot restore political accountability if the precedent has been set that the most consequential decisions a government makes don't require the branch accountable to voters.</p>
          ...
          <div className="bg-[#3ddc84]/10 border border-[#3ddc84]/20 rounded-lg p-6 my-6 text-center">
            <p className="font-condensed font-bold text-xl text-white">Peace isn't the last ring.<br />Peace is what makes every other ring functional.</p>
          </div>
        </div>
        ...
        <div className="text-center mb-12">
          <span className="font-condensed font-bold text-[#3ddc84] text-sm uppercase tracking-wide">The Pattern</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-6">The Spiral — <span className="text-red-500">How They Feed Each Other Right Now</span></h2>

          <div className="max-w-[640px] mx-auto text-left space-y-0">
            <div className="p-3 bg-red-500/15 border-l-4 border-red-500 rounded-r-md text-white font-condensed font-bold">Military escalation → oil price shock</div>
            <div className="p-3 bg-red-500/10 border-l-4 border-red-500/60 rounded-r-md text-white font-condensed font-bold">→ Every supply chain tightens</div>
            <div className="p-3 bg-red-500/8 border-l-4 border-red-500/40 rounded-r-md text-white font-condensed font-bold">→ Healthcare more expensive</div>
            <div className="p-3 bg-[#ffd60a]/10 border-l-4 border-[#ffd60a]/40 rounded-r-md text-white font-condensed font-bold">→ Workers sicker, under more financial pressure</div>
            <div className="p-3 bg-[#ffd60a]/8 border-l-4 border-[#ffd60a]/30 rounded-r-md text-white font-condensed font-bold">→ Economy contracts, wages fall</div>
            <div className="p-3 bg-[#3ddc84]/8 border-l-4 border-[#3ddc84]/30 rounded-r-md text-white font-condensed font-bold">→ Desperation rises, political extremism grows</div>
            <div className="p-3 bg-red-500/15 border-l-4 border-red-500 rounded-r-md text-red-500 font-condensed font-bold">→ More escalation risk. Loop repeats.</div>
          </div>

          <div className="bg-[#3ddc84]/10 border-2 border-[#3ddc84]/25 rounded-xl p-7 my-8 max-w-[620px] mx-auto">
            <p className="font-condensed font-bold text-xl text-[#3ddc84] mb-3">PHIERStorm is the pattern interrupt.</p>
            <p className="text-gray-400">The same organized constituent leverage that forces Congress to act on healthcare forces them to act on war powers. The same $2.73 trillion in recovered efficiency funds the jobs that stabilize the economy that de-escalates the politics that reduces the conditions for the next conflict. <strong className="text-white">One lever. Every dimension turns.</strong></p>
          </div>
          ...
          <p className="font-condensed text-gray-500 text-sm mt-4">The only thing missing is you.</p>
        </div>

        {/* PREV/NEXT */}
        <div className="flex justify-between items-center pt-8 mt-8 border-t border-[#3ddc84]/20">
          <Link href="/how-it-works" className="font-condensed font-bold text-gray-500 text-sm px-4 py-2 border border-white/10 rounded-md hover:text-white hover:border-white/30 transition-all">← How It Works</Link>
          <Link href="/simple-math" className="font-condensed font-bold text-[#3ddc84] text-sm px-4 py-2 border border-[#3ddc84]/30 rounded-md hover:bg-[#3ddc84]/10 transition-all">Simple Math →</Link>
        </div>

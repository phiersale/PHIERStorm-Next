...
export default function HomePage() {
  ...
  const [teethPreviewOpen, setTeethPreviewOpen] = useState(false)
    ...
    <>
      ...
      <nav className="sticky top-0 z-50 bg-[#080d1a]/95 backdrop-blur-md border-b border-[#3ddc84]/20 px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:block text-xs text-[#3ddc84] italic">PHIERS · Power Held In Every Representative's Seat</div>
        </div>
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="text-center pt-20 pb-10 px-6">
          <Image src="/images/PHIERS_Logo.png" alt="PHIERS.org" width={90} height={90} className="mx-auto mb-4 opacity-85" />
        ...
        <section className="section max-w-[760px] mx-auto px-6 py-16">
          <span className="eyebrow text-2xl tracking-wider">The Problem</span>
        ...
        <section className="section-alt py-16 px-6 bg-[#0a1628] border-y border-[#3ddc84]/10">
          <div className="inner max-w-[760px] mx-auto">
            <span className="eyebrow text-2xl tracking-wider">The Truth</span>
        ...
        {/* What PHIERS Is */}
        <section className="section max-w-[760px] mx-auto px-6 py-16">
          <span className="eyebrow text-2xl tracking-wider">What PHIERS Is</span>
        ...
        {/* How It Works */}
        <section className="section max-w-[760px] mx-auto px-6 py-16" id="how-it-works">
          <span className="eyebrow text-2xl tracking-wider">How It Works</span>
        ...
        {/* Cascade Video */}
        <section className="section max-w-[800px] mx-auto px-6 py-8">
        ...
        <section className="section-alt py-16 px-6 bg-[#0a1628] border-y border-[#3ddc84]/10">
          <div className="inner max-w-[760px] mx-auto text-center">
            <span className="eyebrow text-2xl tracking-wider">The Tipping Point Is Smaller Than You Think</span>
            ...
            <div className="max-w-[380px] mx-auto mt-8 text-center">
              <Image
                ...
                onClick={() => setChenowethModalOpen(true)}
              />
        ...
        {/* Go Deeper */}
        <section className="section max-w-[640px] mx-auto px-6 py-12">
          <p className="eyebrow text-lg tracking-wider">Go Deeper</p>
          ...
          <div className="mb-8">
            ...
            <Link href="/how-it-works" className="font-condensed font-bold text-green no-underline border-b border-green/30 pb-0.5">Show me the Leverage →</Link>
          </div>
          ...
          <div>
            ...
            <Link href="/healthcare-proof" className="font-condensed font-bold text-green no-underline border-b border-green/30 pb-0.5">Explore the Deep Dive →</Link>
          </div>
        </section>
      ...
      <footer className="text-center py-12 px-6 border-t border-[#3ddc84]/10 bg-[#0d1525]">
        <Image src="/images/PHIERS_Logo.png" alt="PHIERS.org" width={100} height={100} className="mx-auto mb-4 opacity-70" />
        <div className="font-condensed font-bold text-gray-400 mb-1">
          PHIERS is the system that gives every union — and everyone without one — the leverage to win.<br />
          Owned by the people. Built by the people.
        </div>
        <div className="text-xs text-gray-500 mt-6 leading-relaxed">
          ...
          <div className="mt-3 font-condensed text-xs">
            🔄 Site updated April 6, 2026 — <Link href="/changelog" className="text-[#3ddc84]">See what changed →</Link>
          </div>
        </div>
      </footer>
      ...
      <AnimatePresence>
        {chenowethModalOpen && (
          <motion.div className="fixed inset-0 bg-black/95 z-[99999] flex items-center justify-center p-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setChenowethModalOpen(false)}>
            <button className="absolute top-5 right-7 text-white text-3xl cursor-pointer bg-black/50 border border-white/20 w-10 h-10 rounded-full" onClick={() => setChenowethModalOpen(false)}>✕</button>
      ...
      <AnimatePresence>
        {teethPreviewOpen && (
          <motion.div className="fixed inset-0 bg-black/95 z-[99999] flex items-center justify-center p-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setTeethPreviewOpen(false)}>
            <button className="absolute top-5 right-7 text-white text-3xl cursor-pointer bg-black/50 border border-white/20 w-10 h-10 rounded-full" onClick={() => setTeethPreviewOpen(false)}>✕</button>

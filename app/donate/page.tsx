        ...
        <section className="max-w-[760px] mx-auto px-6 py-12">
          ...
          <div className="text-center mt-8">
            ...
            <div className="flex flex-col gap-4 max-w-md mx-auto">
              <Link href="/petition" className="px-6 py-3 bg-white text-[#0a5c2e] rounded-lg font-condensed font-extrabold text-center hover:bg-gray-100 transition-all">✍ SIGN THE PETITION</Link>

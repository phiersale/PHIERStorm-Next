      ...
      <main className="pb-16 max-w-[860px] mx-auto px-6">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            ...
            <Link href="/solutions" className="px-6 py-3 bg-transparent text-[#3ddc84] border border-[#3ddc84] rounded-lg font-condensed font-bold hover:bg-[#3ddc84]/10 transition-all">→ See the 5D Solutions</Link>
          </div>
        </div>
        ...
        {/* CORE COMPARISON */}
        <div className="mb-12">
          <span className="font-condensed font-bold text-[#3ddc84] text-sm uppercase tracking-wide">The Core Comparison</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-4">$10,000 vs <span className="text-[#3ddc84]">$600.</span></h2>
          <p className="text-gray-400 mb-3">Replace a <strong className="text-white">$10,000/year insurance product</strong> with a <strong className="text-white">$600/year telehealth-first plan</strong>, and the savings fund:</p>
          ...
          <p className="text-gray-400"><strong className="text-white">All using existing law. No new taxes. No new bureaucracy. Just math.</strong></p>
        </div>
        ...
        <div className="mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-4">One Conversion Funds <span className="text-[#3ddc84]">12–19 More.</span></h2>

          <div className="my-6 text-center">
            <button onClick={() => openModal('/images/SIMPLE_MATH.png')} className="cursor-pointer">
              <Image src="/images/SIMPLE_MATH.png" alt="The Math: One conversion funds exponential coverage" width={500} height={300} className="max-w-full h-auto mx-auto rounded-lg border border-[#3ddc84]/20 hover:scale-[1.02] transition-transform" />
            </button>
            <p className="text-gray-500 text-sm italic mt-2">The Exponential Foundation</p>
          </div>

          <p className="text-gray-400 mb-4"><strong className="text-white">Here's the part Congress doesn't want you to understand:</strong></p>

          <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-6 my-6 text-gray-300 space-y-2">
            ...
            <p>• Those 15 save $141,000 combined</p>
            <p>• That funds <strong className="text-white">235 more</strong></p>
          </div>

          <p className="text-center font-bold text-[#3ddc84] text-lg">It snowballs. Fast. And they know it.</p>
          <p className="text-gray-400 mt-4">And as premiums rise higher — $12,000, $15,000, $18,000 — <strong className="text-white">the cascade accelerates</strong>.</p>
        </div>
        ...
        <div className="mb-12">
          <span className="font-condensed font-bold text-[#3ddc84] text-sm uppercase tracking-wide">The Mathematical Cascade</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-4">234 Million Covered.<br /><span className="text-[#ffd60a]">9 Iterations.</span></h2>

          <div className="my-6 text-center">
            <button onClick={() => openModal('/images/CORE_MATH_for_234M.png')} className="cursor-pointer">
              <Image src="/images/CORE_MATH_for_234M.png" alt="Core Math: How $600 telehealth unlocks 234 million covered" width={500} height={300} className="max-w-full h-auto mx-auto rounded-lg border border-[#3ddc84]/20 hover:scale-[1.02] transition-transform" />
            </button>
            <p className="text-gray-500 text-sm italic mt-2">The Endpoint: Universal Coverage for 234M Americans</p>
          </div>

          <p className="text-gray-400 mb-6">Iteration by iteration, the savings multiply:</p>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 my-6">
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-[#3ddc84]">9</div>
              <div className="text-gray-500 text-sm">Iterations</div>
            </div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-[#3ddc84]">234M</div>
              <div className="text-gray-500 text-sm">Americans Covered</div>
            </div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-[#ffd60a]">$2.73T</div>
              <div className="text-gray-500 text-sm">Annual Savings</div>
            </div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center">
              <div className="font-display text-3xl text-[#3ddc84]">15x+</div>
              <div className="text-gray-500 text-sm">Growth Rate</div>
            </div>
          </div>

          <p className="text-center text-gray-400"><strong className="text-white">This isn't theory. It's arithmetic.</strong></p>
          <p className="text-center text-[#3ddc84] mt-4">The math doesn't stall. It doesn't negotiate. It doesn't care about lobbyists.<br /><strong className="text-white">It just keeps going — until everyone is covered.</strong></p>
        </div>
        ...
        {/* MEDICAID LEVERAGE */}
        <div className="mb-12">
          <span className="font-condensed font-bold text-[#3ddc84] text-sm uppercase tracking-wide">Maximum Leverage</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-4">Why We Start With <span className="text-[#3ddc84]">Medicaid.</span></h2>
          <p className="text-gray-400 mb-3">Most reforms fail because they try to fix everything at once. PHIERS starts where:</p>
          <ul className="list-disc pl-6 text-gray-400 mb-3">
          ...
          <p className="text-gray-400 mb-3">Medicaid costs $8,000 per person. Telehealth costs $600. That's <strong className="text-white">$7,400 in savings</strong> per conversion — enough to fund 12 more.</p>
          <p className="text-gray-400 mb-3"><strong className="text-white">Medicaid is the pressure point.</strong> Once it converts, the rest of the system follows — ACA, private insurance, and the uninsured.</p>
          <p className="text-[#3ddc84]"><strong>Not because Congress wants it. Because the math forces it.</strong></p>
        </div>
        ...
        <div className="mb-12 text-center">
          <div className="my-6">
            <button onClick={() => openModal('/images/3.5pct_Means_Change.png')} className="cursor-pointer">
              <Image src="/images/3.5pct_Means_Change.png" alt="3.5% Means Guaranteed Change - March 28, 2026" width={500} height={300} className="max-w-full h-auto mx-auto rounded-lg border border-[#3ddc84]/20 hover:scale-[1.02] transition-transform" />
            </button>
            <p className="text-gray-500 text-sm italic mt-2">Click to enlarge</p>
          </div>

          <span className="font-condensed font-bold text-[#3ddc84] text-sm uppercase tracking-wide">The 3.5% Rule</span>
          <h2 className="font-display text-3xl md:text-4xl text-white mt-2 mb-4">Why Congress <span className="text-red-500">Is Scared.</span></h2>

          <div className="bg-[#3ddc84]/5 border border-[#3ddc84]/20 rounded-lg p-6 my-6">
            <p className="text-white font-bold mb-3">Harvard research shows that no movement with sustained participation above 3.5% has ever failed.</p>
            <p className="text-gray-400">When 3.5% of Americans take coordinated action, governments either comply or collapse. Over <strong className="text-white">100 million</strong> are already affected by this crisis.</p>
            <p className="text-[#3ddc84] font-bold mt-3">Congress knows the math. Now you do too.</p>
          </div>
        </div>
        ...
        <div className="text-center mb-12">
          <h2 className="font-display text-3xl md:text-4xl text-white mb-3">They Fear the Math.<br /><span className="text-[#3ddc84]">Be Part of It.</span></h2>
          <p className="text-gray-400 mb-6">Sign the petition. Do the math. Force Congress to answer.</p>
        ...
        <div className="flex justify-between pt-8 mt-8 border-t border-[#3ddc84]/20">
          <Link href="/crisis" className="font-condensed font-bold text-[#3ddc84]">← Back to The Crisis</Link>
          <Link href="/solutions" className="font-condensed font-bold text-[#3ddc84]">Next: 5D Solutions →</Link>
        </div>
      </main>

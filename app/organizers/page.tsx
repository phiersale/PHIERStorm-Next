    ...
    <>
      ...
      <main>
        ...
        <div className="pt-20 pb-8 px-6 max-w-[760px] mx-auto">
          ...
          <p className="font-condensed text-xl text-gray-500 mb-4">You've organized the marches. You've built the coalitions. You've kept people engaged through exhaustion and disappointment. You know better than anyone what happens without a mechanism behind the energy.</p>
          <p className="font-condensed text-xl text-white mb-4">Congress waits it out. The moment passes. Your people have to be re-motivated all over again.</p>
          <p className="font-condensed text-xl text-[#3ddc84]">PHIERS is the mechanism that changes that permanently — and it works alongside everything you've already built.</p>
        </div>
        ...
        <section className="py-12 px-6 max-w-[760px] mx-auto">
          <div className="border-2 border-red-500 bg-red-500/10 rounded-xl p-8">
        ...
        <section className="py-12 px-6 max-w-[760px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-8">
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-6"><div className="text-2xl mb-2">💊</div><div className="font-display text-3xl text-[#ffd60a] mb-1">$10K+</div><h3 className="font-condensed font-bold text-lg text-[#3ddc84] mb-2">Annual savings per member</h3><p className="text-gray-400 text-sm">$600 telehealth replaces $10,000+ traditional coverage — and that number keeps climbing as the war drives up costs across healthcare, energy, and supply chains. Every member. Immediately when Congress acts.</p></div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-6"><div className="text-2xl mb-2">🏛️</div><div className="font-display text-3xl text-[#ffd60a] mb-1">1,500</div><h3 className="font-condensed font-bold text-lg text-[#3ddc84] mb-2">Signatures triggers a town hall</h3><p className="text-gray-400 text-sm">That's less than 0.5% of most districts. Your rep has to show up, answer, and go on the record. Before the election.</p></div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-6"><div className="text-2xl mb-2">💼</div><div className="font-display text-3xl text-[#ffd60a] mb-1">$0</div><h3 className="font-condensed font-bold text-lg text-[#3ddc84] mb-2">Cost to your organization</h3><p className="text-gray-400 text-sm">PHIERS partnership costs nothing. You point your people to the mechanism. We handle the coordination, the district tracking, the town halls.</p></div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-6"><div className="text-2xl mb-2">⚡</div><div className="font-display text-3xl text-[#ffd60a] mb-1">3.5%</div><h3 className="font-condensed font-bold text-lg text-[#3ddc84] mb-2">The threshold that never fails</h3><p className="text-gray-400 text-sm">Harvard research: no sustained campaign at 3.5% participation has ever failed. Unions alone are already close. Together we blow past it.</p></div>
          </div>
        ...
        <section className="py-12 px-6 bg-[#0a1628] border-y border-[#3ddc84]/10">
          <div className="max-w-[760px] mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-5 mb-6">
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-6"><span className="font-condensed font-black text-red-500 text-xs uppercase tracking-wide block mb-3">✗ Protest Alone</span><ul className="space-y-2 text-gray-400 text-sm"><li>• Creates visibility and news coverage</li><li>• Congress waits it out — they have practice</li><li>• No district-level documentation</li><li>• No electoral consequence attached</li><li>• Energy fades. Re-motivation required. Again.</li><li>• Representatives feel no personal risk</li></ul></div>
              <div className="bg-[#3ddc84]/10 border border-[#3ddc84]/20 rounded-lg p-6"><span className="font-condensed font-black text-[#3ddc84] text-xs uppercase tracking-wide block mb-3">✓ Protest + PHIERS</span><ul className="space-y-2 text-gray-400 text-sm"><li>• Visibility AND documented leverage</li><li>• 1,500 signatures triggers mandatory town hall</li><li>• Every name counted by district, delivered to rep</li><li>• Organized primary challenge if they refuse</li><li>• Mechanism doesn't fade — it builds permanently</li><li>• Representatives face a documented career risk</li></ul></div>
            </div>
        ...
        <section className="py-12 px-6 max-w-[760px] mx-auto">
          ...
          <div className="space-y-5">
            <div className="flex gap-4"><div className="w-11 h-11 rounded-full bg-[#3ddc84] text-[#080d1a] flex items-center justify-center font-condensed font-black text-lg flex-shrink-0">1</div><div><div className="font-condensed font-bold text-lg text-white mb-1">Your Members Add Their Name</div><div className="text-gray-400 text-sm">Name, email, zip code. Counted in their congressional district — not dumped into a national pile Congress can ignore. This is the district-level record that makes PHIERS different from every petition they've signed before.</div></div></div>
            <div className="flex gap-4"><div className="w-11 h-11 rounded-full bg-[#3ddc84] text-[#080d1a] flex items-center justify-center font-condensed font-black text-lg flex-shrink-0">2</div><div><div className="font-condensed font-bold text-lg text-white mb-1">We Coordinate District by District</div><div className="text-gray-400 text-sm">We track every district in real time. When a district is approaching the threshold, we notify both the members in that district and reach out directly to the representative. They know what's coming. That pressure starts before the town hall is even scheduled.</div></div></div>
            <div className="flex gap-4"><div className="w-11 h-11 rounded-full bg-[#3ddc84] text-[#080d1a] flex items-center justify-center font-condensed font-black text-lg flex-shrink-0">3</div><div><div className="font-condensed font-bold text-lg text-white mb-1">1,500 Triggers a Mandatory Public Town Hall</div><div className="text-gray-400 text-sm">We contact every signer in that district directly. Your members are in the room. Their representative has to answer — on the record, publicly, before the next election. Not in a controlled setting. Not with pre-screened questions. A real accountability moment.</div></div></div>
            <div className="flex gap-4"><div className="w-11 h-11 rounded-full bg-[#3ddc84] text-[#080d1a] flex items-center justify-center font-condensed font-black text-lg flex-shrink-0">4</div><div><div className="font-condensed font-bold text-lg text-white mb-1">They Comply — or They Face the Ballot Box</div><div className="text-gray-400 text-sm">Representatives who act get protected and credited. Representatives who refuse face an organized primary challenge — coordinated, funded, and ready. We do not wait for November. We do not accept silence as an answer.</div></div></div>
            <div className="flex gap-4"><div className="w-11 h-11 rounded-full bg-red-600 text-white flex items-center justify-center font-condensed font-black text-lg flex-shrink-0">5</div><div><div className="font-condensed font-bold text-lg text-red-500 mb-1">Enough Districts = Congress Has No Choice</div><div className="text-gray-400 text-sm">When enough districts hit the threshold simultaneously, the math changes for every member of Congress. This isn't one noisy district they can ignore. It's their colleagues going down. At that point, acting is safer than refusing — and we win.</div></div></div>
          </div>
        </section>
        ...
        <section className="py-12 px-6 max-w-[760px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center"><div className="font-display text-3xl text-[#3ddc84] mb-2">01</div><p><strong className="text-white">Send your members the petition link.</strong> One email. One newsletter. One Slack message. You know how to reach them — we don't need to teach you that.</p></div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center"><div className="font-display text-3xl text-[#3ddc84] mb-2">02</div><p><strong className="text-white">Tell them why in your words.</strong> You have credibility with your members that no outside organization can replicate. Use it. The math does the rest.</p></div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 text-center"><div className="font-display text-3xl text-[#3ddc84] mb-2">03</div><p><strong className="text-white">Reach out so we can coordinate.</strong> When your district hits the threshold, your members need to be in the room. We make sure that happens — but only if we know you're with us.</p></div>
          </div>
      ...
      <footer className="text-center py-12 px-6 border-t border-[#3ddc84]/10 bg-[#0d1525]">
        <div className="font-condensed font-bold text-xl text-[#3ddc84] mb-2">Energy without power fails.<br />PHIERStorm is the power.</div>
        <div className="text-sm text-gray-500 mb-5">PHIERS is a people's movement — not a company, not a product.<br />Built by regular people who refused to stop.</div>
        <div className="flex flex-wrap justify-center gap-4 max-w-2xl mx-auto mb-6">
          ...
          <Link href="/unions" className="text-gray-500 text-sm hover:text-[#3ddc84]">Union Strategy</Link>
          <Link href="/veterans" className="text-gray-500 text-sm hover:text-[#3ddc84]">Veterans</Link>
          <Link href="/petition" className="text-gray-500 text-sm hover:text-[#3ddc84]">Sign the Petition</Link>

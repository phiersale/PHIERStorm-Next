    ...
    <>
      ...
      <main className="pt-20 pb-16 max-w-[900px] mx-auto px-6">
        ...
        <div className="bg-red-500/10 border-2 border-red-500/30 border-l-4 border-l-red-500 rounded-lg p-6 my-8">
          ...
          <div className="bg-black/25 border-l-4 border-[#ffd60a] rounded-lg p-4 my-4">
            <p className="text-[#ffd60a] font-bold mb-2">Stage 1 — Fix healthcare.</p>
            <p className="text-gray-300 mb-3">Prove PHIERS works. Generate $2.7 trillion in savings. Show Congress that organized constituents cannot be ignored.</p>
            <p className="text-[#ffd60a] font-bold mb-2">Stage 2 — Transfer that leverage.</p>
            <p className="text-gray-300">Use the same organized, documented, district-by-district pressure to demand Congress end the unauthorized wars.</p>
          </div>
        ...
        <div className="bg-red-500/10 border-2 border-red-500/30 rounded-xl p-8 my-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            <Link href="/petition" className="px-6 py-2 bg-red-600 text-white font-condensed font-bold rounded-lg hover:bg-red-700 transition-all">✍ Sign the Petition</Link>
            <Link href="/donate" className="px-6 py-2 bg-transparent text-[#3ddc84] border border-[#3ddc84] rounded-lg font-condensed font-bold hover:bg-[#3ddc84]/10 transition-all">Support the Movement</Link>
          </div>

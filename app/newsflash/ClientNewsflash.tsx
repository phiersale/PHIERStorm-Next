...
/* VERSION: 2.4.0 – original header with dark circle behind PHIERS_Logo.png */
...
export default function ClientNewsflash() {
  ...
  return (
    <>
      ...
      <button
        onClick={handleClose}
        className="fixed top-4 right-4 z-50 bg-black/70 hover:bg-black/90 text-white rounded-full w-12 h-12 flex items-center justify-center text-2xl shadow-lg backdrop-blur-sm transition-all active:bg-black/90"
        aria-label="Close newsflash and go back"
      >
        ✕
      </button>

      <div className="nf-wrap">
        {/* Original header – white background, dark circle behind logo */}
        <div className="nf-header">
          <div className="text-center mb-2">
            ...
            />
            <div className="nf-logo text-center">Headline News & Our Response</div>
          </div>
          <div className="nf-tagline text-center">Organized leverage. The kind Congress already fears.</div>
          <div className="nf-dateline text-center">May 2026 &nbsp;·&nbsp; Issue #2</div>
        </div>

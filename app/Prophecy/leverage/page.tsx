...
// VERSION: 6.0.0 – Light theme (mechanism), fade wrapper only
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start mb-12">
            ...
            <div className="flex-1">
              <p className="text-xl font-semibold text-black">You are not powerless.</p>
          ...
          <div className="my-12">
            <Accordion triggerLabel="Why does 1,500 matter?">
              <p className="text-gray-800">Most people are taught that ordinary citizens have no real influence. That's exactly what they want you to believe.</p>
              <p className="mt-2 text-gray-800">The truth: small, organized, coordinated blocs of constituents create outsized political power at the district level. Community organizers have known this for generations.</p>
              <p className="mt-2 text-gray-800">Representatives don't fear random anger. They fear organized people who show up — at primaries, town halls, the polls, and in the public record.</p>
              <p className="mt-2 text-gray-800">1,500 aligned constituents in a single congressional district can flip a primary, force public accountability, and make a sitting representative's career genuinely uncertain before election day.</p>
              <p className="mt-2 text-gray-800">The full architecture lives at PHIERS.org. Short version: organized people are the leverage Congress cannot ignore.</p>
            </Accordion>
          </div>

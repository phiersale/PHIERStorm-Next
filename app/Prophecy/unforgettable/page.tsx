        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="my-12 text-center">
            <p className="text-gray-800 text-lg leading-relaxed">
              ...
              <strong>And you see clearly:</strong> they are still trying to erase us. Right now. Today. Museums closed. History whitewashed. Our heroes removed from the record. But we know what we did. We know what we built. And we know how to finish it.
            </p>
          </div>

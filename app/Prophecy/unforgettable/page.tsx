...
// VERSION: 6.0.0 – Dark theme, all text mapped to gray/white, cinematic spacing, fade wrapper
    ...
    >
      ...
      <div className="sticky-header-offset min-h-screen bg-black text-white">
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <StatCard>
            Too many of us met the prison system before we ever met a real opportunity.
          </StatCard>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start my-12">
            ...
            />
            <div className="flex-1">
              <p className="text-lg font-semibold mb-2 text-white">Slavery ended on paper in 1865.<br />The labor never stopped.</p>
          ...
          <PullQuote>
            ...
            Then they told us we were the problem.
          </PullQuote>
          ...
          <div className="my-12 text-center">
            <p className="text-gray-200 text-lg leading-relaxed">
              ...
              And you start seeing your own life differently.<br /><br />
              <strong className="text-white">And you see clearly:</strong> they are still trying to erase us. Right now. Today. Museums closed. History whitewashed. Our heroes removed from the record. But we know what we did. We know what we built. And we know how to finish it.
            </p>
          </div>

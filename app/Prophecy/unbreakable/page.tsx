...
// VERSION: 5.2.0 – Verified clean syntax
    ...
    <div className="sticky-header-offset min-h-screen bg-white text-black">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start my-12">
          <ImageThumbnail src="/images/trilogy/greenwood.jpg" alt="Greenwood District" className="md:w-1/3" />
          <div className="flex-1">
            <p className="text-lg font-semibold mb-2">They built an entire world from nothing.<br />Then the mobs came. And the government watched.</p>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start my-12">
          <ImageThumbnail src="/images/trilogy/761st.jpg" alt="761st Tank Battalion" className="md:w-1/3" />
          <div className="flex-1">
            <p className="text-lg font-semibold mb-2">183 days at the front. Six countries.<br />The hole they punched through the Siegfried Line is the hole Patton drove through into Germany.</p>
            <Accordion triggerLabel="The full story">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start my-12">
          <ImageThumbnail src="/images/trilogy/gunskirchen.jpg" alt="Liberation of Gunskirchen" className="md:w-1/3" />
          <div className="flex-1">
            <p className="text-lg font-semibold mb-2">A 17‑year‑old Holocaust survivor looked at her liberator and wrote a poem. She called him "The Black Messiah."</p>
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start my-12">
          <div className="md:w-1/3 space-y-4">
            <ImageThumbnail src="/images/trilogy/Me_w_Tuskegee_Airman_George_SpankyRoberts_Family.jpg" alt="Will Price with family of Tuskegee Airman George Roberts" className="w-full" />
            <ImageThumbnail src="/images/trilogy/Me_n_Dad_at_CHURCH.jpg" alt="Will Price and his father at church" className="w-full" />
          </div>
          <div className="flex-1">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start my-12">
          <ImageThumbnail src="/images/trilogy/tuskegee.jpg" alt="Tuskegee Airmen" className="md:w-1/3" />
          <div className="flex-1">
            <p className="text-lg font-semibold mb-2">Bomber crews requested them by name.<br />They destroyed the factories that built Hitler's tanks.<br />Then came home to segregation.</p>
            <Accordion triggerLabel="The full story">
        ...
        <div className="bg-black text-white p-8 rounded-lg my-12 text-center">
          ...
          <p className="text-gray-300 mt-4">You come from men who built entire cities from scratch — and rebuilt after arson.<br />Who liberated the persecuted while still carrying oppression themselves.<br />Who flew the most dangerous missions of the war for a country that wouldn't let them sit at a lunch counter when they landed.</p>
          <p className="text-gray-300 mt-4">They tried to erase us then. They are trying to erase us now.</p>
          <p className="text-gray-300 mt-2">But we are still here. And we have something they never expected: <strong>the receipts, the connections, the strategy, and the will.</strong></p>
          <p className="text-white font-bold text-2xl mt-6">That is not ancient history. That is your inheritance.</p>
          <PullQuote>That strength is not behind you.<br />It is in you. Right now.<br />It never left.</PullQuote>
          <p className="text-white font-bold text-xl mt-4">PHIERS is the instrument. The petition is the voice. The survey is the map.</p>
          <p className="text-white font-bold text-xl mt-2">This time, we finish it.</p>
        </div>

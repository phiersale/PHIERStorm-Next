    ...
    <>
      ...
      <main className="pt-20 pb-16 max-w-[880px] mx-auto px-6">
        ...
        <div className="mb-12">
          ...
          <div className="bg-red-500/10 border-l-4 border-red-500 rounded-r-lg p-6 my-6">
            <p className="text-gray-300 mb-3">The VA just tried to slip a rule into the Federal Register — effective immediately, no public notice — that would have cut disability benefits for veterans who take medication. A veteran with 100% PTSD rating could have dropped to 30% <em>simply because their medication was working.</em></p>
            <p className="text-white font-semibold mt-3">They backed off after 10,000+ public comments in 60 hours. <strong className="text-red-500">But the rule is still on the books. They can reinstate it any time.</strong></p>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse my-6 text-sm">
              <thead>
                <tr className="border-b border-[#3ddc84]/20">
                  <th className="text-left py-3 px-4 font-condensed text-gray-500 text-xs uppercase tracking-wide">What They Tell You</th>
                  <th className="text-left py-3 px-4 font-condensed text-gray-500 text-xs uppercase tracking-wide">The Truth</th>
                </tr>
              </thead>
              <tbody>
        ...
        <div className="mb-12">
          ...
          <div className="border-l-4 border-[#ffd60a] bg-[#ffd60a]/10 rounded-r-lg p-5 my-5">
            <p className="text-white italic">"The VA was designed to serve a fraction of veterans. Even at its best, it leaves more than half behind. I didn't leave because the VA was being cut — I left because the architecture was never built to serve all veterans in the first place. PHIERS is the architecture that does."</p>
          </div>

          <div className="border-l-4 border-[#ffd60a] bg-[#ffd60a]/10 rounded-r-lg p-5">
            <p className="text-white italic">"When I saw them trying to cut benefits for veterans whose medication was working — that's when I knew we couldn't wait anymore. They're not just cutting the VA. They're cutting veterans. PHIERS is the only plan that makes your health coverage independent of their budget cuts."</p>
            <p className="text-[#ffd60a] text-sm mt-3">— Will Price, Chief Solutions Architect, PHIERS Movement</p>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="bg-red-500/10 border-l-4 border-red-500 rounded-r-lg p-5 my-5">
            <p className="text-gray-300">The unauthorized war is already hitting your grocery bill, your gas prices, and your electric bill. And they're about to ask your kids to fight in it — with no congressional vote, no mandate, no exit strategy. <Link href="/no-war" className="text-red-500 font-bold">→ See the full economic cascade on the No War page</Link></p>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="bg-[#ffd60a]/10 border-l-4 border-[#ffd60a] rounded-r-lg p-5">
            <strong className="text-[#ffd60a]">March 28, 2026 is the No Kings Rally.</strong> It's also the deadline for Congress to act on telehealth. If we're organized by then, they have no choice. They sent you to war. Now you send them a message.
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 my-6">
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 flex gap-4">
              <div className="font-display text-2xl text-red-500 min-w-[40px]">1</div>
              <div><h3 className="font-condensed font-bold text-white text-lg mb-1">Sign the Petition</h3><p className="text-gray-400 text-sm">Every signature tells Congress: veterans are watching, veterans are organized, and veterans vote. Put your name on the record.</p></div>
            </div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 flex gap-4">
              <div className="font-display text-2xl text-red-500 min-w-[40px]">2</div>
              <div><h3 className="font-condensed font-bold text-white text-lg mb-1">Take the Survey</h3><p className="text-gray-400 text-sm">Tell us what's hitting hardest — healthcare access, mental health, disability ratings, the medication trap. Your answers get delivered to your representatives.</p></div>
            </div>
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-lg p-5 flex gap-4">
              <div className="font-display text-2xl text-red-500 min-w-[40px]">3</div>
              <div><h3 className="font-condensed font-bold text-white text-lg mb-1">Share With Every Veteran You Know</h3><p className="text-gray-400 text-sm">This isn't a partisan issue. This isn't left or right. This is every veteran who was promised something and got nothing. Share it.</p></div>
            </div>
          </div>
        </div>

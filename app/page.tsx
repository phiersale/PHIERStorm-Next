...
import { Menu, X, ChevronRight, ArrowRight, Shield, Zap, Heart, Users, AlertTriangle } from 'lucide-react'
    ...
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#080d1a]/95 backdrop-blur-md border-b border-[#3ddc84]/20 px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:block text-xs text-[#3ddc84] italic">
        ...
        <div className="flex items-center gap-4">
          ...
          <button onClick={toggleMenu} className="md:hidden text-white text-2xl p-2 border border-white/20 rounded-lg">
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="space-y-4">
              <Link href="/no-war" className="block p-4 bg-red-500/10 border border-red-500/30 rounded-lg text-red-400 font-condensed font-bold text-center" onClick={() => setMobileMenuOpen(false)}>
              ...
              <Link href="/petition" className="block w-full py-3 bg-[#3ddc84] text-[#080d1a] font-condensed font-bold text-center rounded-lg mt-4" onClick={() => setMobileMenuOpen(false)}>
                ✍ Sign Now
              </Link>
            </div>
          </motion.div>
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="px-4 max-w-[900px] mx-auto text-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/10 border border-red-500/30 rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-red-400 uppercase tracking-wide">The Crisis Is Now</span>
            </div>

            {/* TWO-TONE HERO HEADLINE - Different sizes and colors */}
            <h1 className="mb-6">
              <span className="block text-4xl sm:text-5xl md:text-6xl font-bold text-white tracking-tight mb-3">
                America Isn't Facing Five Crises.
              </span>
              <span className="block text-3xl sm:text-4xl md:text-5xl font-bold text-[#3ddc84] tracking-tight">
            ...
            <Link 
              href="/leverage" 
              className="inline-flex items-center gap-2 mt-8 px-8 py-3 bg-transparent text-[#3ddc84] border-2 border-[#3ddc84] rounded-full font-condensed font-bold hover:bg-[#3ddc84]/10 transition-all"
            >
              See How It Works → 
            </Link>
          </motion.div>
        ...
        <section className="px-4 py-12 max-w-[720px] mx-auto">
          <div className="bg-white/5 border border-white/10 rounded-xl p-8 text-center">
            ...
            <div className="max-w-[200px] mx-auto mb-6">
              <Image 
                src="/images/fork_in_road_decision.jpg" 
                alt="A fork in the road - choose your path"
                width={200}
                height={150}
            ...
            <div className="flex flex-col gap-4 max-w-md mx-auto">
              <Link href="/petition" className="w-full px-6 py-3 bg-white text-[#0a5c2e] border-2 border-[#0a5c2e] rounded-lg font-condensed font-extrabold text-center hover:bg-gray-100 transition-all">
                I'm an individual — add my name
              </Link>
              <Link href="/organizers" className="w-full px-6 py-3 bg-transparent text-[#3ddc84] border-2 border-[#3ddc84] rounded-lg font-condensed font-bold text-center hover:bg-[#3ddc84]/10 transition-all">
                I represent a group or organization
              </Link>
            </div>
        ...
        <section className="px-4 py-8 max-w-[720px] mx-auto">
          <div className="bg-white/5 border border-white/10 rounded-xl p-8">
            ...
            <div className="mt-6 text-center">
              <Link href="/petition" className="inline-flex items-center gap-2 px-8 py-3 bg-white text-[#0a5c2e] border-2 border-[#0a5c2e] rounded-lg font-condensed font-bold hover:bg-gray-100 transition-all">
          ...
          <div className="max-w-[480px] mx-auto">
            <div className="relative aspect-video rounded-xl overflow-hidden border border-[#3ddc84]/20 shadow-lg">
              <iframe
                ...
                title="How PHIERS Forces Congress to Respond"
                allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
                className="absolute inset-0 w-full h-full"
              />
            </div>
            <p className="font-condensed text-gray-400 mt-3">
              1,500 people per district. 657,000 total. Built over 16 years.<br />
              <span className="text-[#3ddc84] font-bold">This is how we make Congress do its job.</span>
            </p>
          </div>
        </section>
        ...
        <section className="px-4 py-16 max-w-[760px] mx-auto">
          ...
          <div className="space-y-8">
            {[
              { num: '1', title: 'People sign', desc: 'Adding your name isn\'t symbolic. It\'s how we organize pressure.' },
              { num: '2', title: 'We coordinate by district', desc: 'Real people. Real numbers. Tied to the representatives who have to respond.' },
              { num: '3', title: 'Pressure becomes unavoidable', desc: 'When enough people act together, ignoring them becomes more dangerous than responding.' },
              { num: '4', title: 'Congress responds — or gets replaced', desc: 'That\'s how leverage works.', isRed: true },
            ].map((step, i) => (
              <motion.div 
                key={i}
              ...
              >
                <div className={`w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 font-condensed font-black text-xl ${step.isRed ? 'bg-red-600 text-white' : 'bg-[#3ddc84] text-[#080d1a]'}`}>
                  {step.num}
                </div>
                <div>
                  <div className={`font-condensed font-bold text-xl text-white mb-1 ${step.isRed ? 'text-red-500' : ''}`}>{step.title}</div>
          ...
          <div className="text-center mt-8">
            <Link href="/petition" className="inline-flex items-center gap-2 px-8 py-3 bg-white text-[#0a5c2e] border-2 border-[#0a5c2e] rounded-lg font-condensed font-extrabold hover:bg-gray-100 transition-all">
              ✍ Add Your Name →
            </Link>
          </div>
        </section>
          ...
          <div className="max-w-[760px] mx-auto text-center">
            ...
            <div className="mt-8 max-w-[380px] mx-auto">
              <Image 
                ...
                width={380}
                height={250}
                className="rounded-lg border border-white/10 cursor-pointer hover:scale-[1.02] transition-transform"
              />
        ...
        <section className="px-4 py-16 max-w-[800px] mx-auto">
          <div className="relative aspect-video rounded-xl overflow-hidden border border-[#3ddc84]/20">
            <div className="video-wrap" id="wrap-cascade" style={{ position: 'relative', width: '100%', height: '100%' }}>
              ...
              >
                <div className="absolute inset-0 bg-black/30 flex items-center justify-center text-5xl text-white/90 cursor-pointer">
                  ▶
                </div>
              </div>
            </div>
        ...
        <section className="px-4 py-16 bg-[#0a1628] border-y border-[#3ddc84]/10">
          <div className="max-w-[1000px] mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { icon: '⚡', title: 'Political Power', subtitle: 'Make Congress respond', desc: 'When enough people act together, Congress has two choices: respond — or get replaced.', punchline: 'PHIERStorm creates that pressure.', borderColor: 'border-t-red-500' },
                { icon: '💰', title: 'Economic Power', subtitle: 'Make the math work', desc: 'The system is already wasting trillions. Redirecting that money changes everything.', punchline: 'The math is undeniable. Congress knows it.', borderColor: 'border-t-[#ffd60a]' },
                { icon: '🛒', title: 'Consumer Power', subtitle: 'Make the market respond', desc: 'We don\'t just boycott. We organize how we spend — and outcompete broken systems.', punchline: 'That\'s how pressure becomes permanent.', borderColor: 'border-t-[#3ddc84]' },
              ].map((item, i) => (
                <motion.div 
                  key={i}
                  initial={{ opacity: 0, y: 20 }}
                  ...
                  transition={{ duration: 0.5, delay: i * 0.1 }}
                  viewport={{ once: true }}
                  className={`bg-[#111d35] border border-[#3ddc84]/20 rounded-xl p-7 h-full border-t-4 ${item.borderColor}`}
                >
                  <div className="text-3xl mb-3">{item.icon}</div>
                  <div className="font-display text-2xl text-white mb-1">{item.title}</div>
                  <div className="text-gray-400 text-sm mb-3">{item.subtitle}</div>
                  <p className="text-gray-400 text-sm mb-3">{item.desc}</p>
                  <div className="font-condensed font-bold text-[#3ddc84] text-sm pt-3 border-t border-white/10 mt-3">{item.punchline}</div>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="px-4 py-16 text-center">
          <div className="max-w-[1000px] mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              <Link href="/leverage" className="block max-w-[260px] w-full p-6 rounded-xl bg-[#3ddc84]/10 border-2 border-[#3ddc84]/70 hover:-translate-y-1 transition-all">
          ...
          <div className="max-w-[800px] mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                ...
                { href: '/solutions', label: '🔬 5D Solutions' },
                { href: '/telecare', label: '💡 TeleCARE' },
                { href: '/organizers', label: '✊ For Organizers' },
                { href: '/veterans', label: '🎖 Veterans' },
                { href: '/unions', label: '💪 Union Strategy' },
                ...
                <Link
                  key={i}
                  href={link.href}
                  className="block px-4 py-3 bg-[#111d35] border border-[#3ddc84]/15 rounded-full text-gray-300 text-sm font-semibold text-center hover:border-[#3ddc84] hover:bg-[#3ddc84]/10 transition-all"
                >
                  {link.label}
                </Link>
              ))}
      ...
      {/* ── FOOTER ── */}
      <footer className="text-center py-12 px-4 border-t border-[#3ddc84]/10">
        <Image 
          src="/images/PHIERS_Logo.png" 
          alt="PHIERS.org" 
          width={80} 
        ...
        <div className="max-w-[500px] mx-auto mb-6">
          <p className="font-condensed text-gray-400">
            Energy without power fails.<br />
            PHIERStorm is the power.<br />
            <span className="text-gray-500">PHIERS.org — a catalyst for the change we've been waiting for.</span><br />
            <span className="text-gray-500">The only thing missing is you.</span>
          </p>
        </div>
        <div className="max-w-[500px] mx-auto p-4 border border-[#3ddc84]/20 rounded-xl mb-6">
          <p className="font-condensed text-gray-500 text-xs uppercase tracking-wide mb-1">Built by</p>
          <p className="font-condensed font-bold text-white">Will Price | Founder &amp; Chief Solutions Architect</p>
          <p className="font-condensed text-gray-400 text-sm mb-2">Not a politician. Not a lobbyist. A systems architect who found $2.7 trillion in wasted spending and built the lever to fix it. Building this since 2009.</p>
        </div>
        ...
        <div className="text-xs text-gray-600">
          ...
          <span className="text-xs">PHIERS™ · PHIERSale™ · PHIERWorks™ · PHIERPlace™ — Protected marks established 2009–2025.</span>
        </div>
      </footer>
      ...
      <style jsx global>{`
        @import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Barlow:ital,wght@0,400;0,600;0,700;1,400&family=Barlow+Condensed:wght@400;600;700;900&display=swap');

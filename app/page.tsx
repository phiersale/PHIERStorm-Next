  ...
  return (
    <>
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="px-6 py-8 max-w-[900px] mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center max-w-2xl mx-auto">
            <Link href="/petition" className="px-8 py-4 bg-white text-[#0a5c2e] rounded-lg font-condensed font-extrabold text-center hover:bg-gray-100 transition-all">✍ I'm ready to be counted — add my name</Link>
            <Link href="/organizers" className="px-8 py-4 bg-transparent text-[#3ddc84] border-2 border-[#3ddc84] rounded-lg font-condensed font-bold text-center hover:bg-[#3ddc84]/10 transition-all">✊ I bring people — show me what PHIERS does for them</Link>
          </div>
          <p className="text-xs text-gray-500 mt-3">name · email · zip · counted in your district</p>
        </section>

        <hr className="border-[#3ddc84]/20" />

        {/* SECTION 1 — THE REALITY */}
        <section className="section max-w-[760px] mx-auto px-6 py-16">
          <span className="eyebrow text-2xl tracking-wider">The Reality</span>
        ...
        <section className="section-alt py-16 px-6 bg-[#0a1628] border-y border-[#3ddc84]/10">
          <div className="inner max-w-[760px] mx-auto">
            <span className="eyebrow text-2xl tracking-wider">The Failure</span>
        ...
        <section className="section max-w-[760px] mx-auto px-6 py-16">
          <span className="eyebrow text-2xl tracking-wider">The Mechanism</span>
          ...
          <p className="text-gray-400 mb-3">Built over 16 years.</p>
          ...
          <div className="space-y-6 mb-8">
            <p className="text-gray-300 text-lg">You add your name.</p>
            <p className="text-gray-300 text-lg">It becomes part of a district count.</p>
            <p className="text-gray-300 text-lg">The count reaches threshold.</p>
            <p className="text-gray-300 text-lg">Pressure becomes unavoidable.</p>
            <p className="text-gray-300 text-lg">Response follows.</p>
          </div>
          ...
          <div className="space-y-8 mt-8">
            <div>
              <p className="font-condensed font-bold text-xl text-white mb-2">1. You add your name</p>
              <p className="text-gray-400">A real number tied to your representative — verified, by district, on the record.</p>
            </div>
            <div>
              <p className="font-condensed font-bold text-xl text-white mb-2">2. We coordinate district by district</p>
              <p className="text-gray-400">Real people. Real numbers. Tied to the representatives who have to respond.</p>
            </div>
            <div>
              <p className="font-condensed font-bold text-xl text-white mb-2">3. Pressure becomes unavoidable</p>
              <p className="text-gray-400">When enough people act together, ignoring them becomes more dangerous than responding.</p>
            </div>
            <div>
              <p className="font-condensed font-bold text-xl text-white mb-2">4. Congress responds — or gets replaced</p>
              <p className="text-gray-400">That's how leverage works. That's how it has always worked. That's how it works now.</p>
            </div>
          </div>
        </section>
        ...
        {/* SECTION 4 — THE MATH */}
        <section className="section-alt py-16 px-6 bg-[#0a1628] border-y border-[#3ddc84]/10">
          <div className="inner max-w-[760px] mx-auto text-center">
            <span className="eyebrow text-2xl tracking-wider">The Math</span>
        ...
        <section className="section max-w-[1000px] mx-auto px-6 py-16">
          <div className="text-center mb-12">
            <span className="eyebrow text-2xl tracking-wider">Three Kinds of Power</span>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-xl p-7 h-full border-t-4 border-t-red-500">
              ...
              <p className="text-gray-400 text-sm mb-3">Organized people forcing Congress to respond.</p>
              <p className="text-gray-400 text-sm">When 1,500 constituents in a district are on the record with a specific demand, their representative has two choices: act — or face replacement. PHIERStorm makes that unavoidable.</p>
            </div>
            ...
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-xl p-7 h-full border-t-4 border-t-[#ffd60a]">
              ...
              <p className="text-gray-400 text-sm mb-3">Redirecting trillions already being wasted.</p>
              <p className="text-gray-400 text-sm">$10,000 per person vs. $600 per person. Same care. One-sixteenth the cost. $2.73 trillion in annual savings. The money exists. We're just using it wrong.</p>
            </div>
            ...
            <div className="bg-[#111d35] border border-[#3ddc84]/20 rounded-xl p-7 h-full border-t-4 border-t-[#3ddc84]">
              ...
              <p className="text-gray-400 text-sm mb-3">Organizing how we spend so broken systems can't survive.</p>
              <p className="text-gray-400 text-sm">We buy from the same suppliers corporations use — and undercut them permanently, because we don't need to extract profit from our own people.</p>
            </div>
          </div>
        ...
        <section className="section-alt py-16 px-6 bg-[#0a1628] border-y border-[#3ddc84]/10">
          <div className="inner max-w-[760px] mx-auto text-center">
            <span className="eyebrow text-2xl tracking-wider">Inevitability</span>
        ...
        {/* SECTION 7 — CREDIBILITY SNAPSHOT */}
        <section className="section max-w-[760px] mx-auto px-6 py-16">
          <span className="eyebrow text-2xl tracking-wider">Credibility</span>
        ...
        {/* FINAL CTA */}
        <section className="section max-w-[600px] mx-auto px-6 py-16 text-center">
          ...
          <div className="flex flex-col gap-4 max-w-md mx-auto">
            ...
            <Link href="/organizers" className="px-8 py-4 bg-transparent text-[#3ddc84] border-2 border-[#3ddc84] rounded-lg font-condensed font-bold text-center hover:bg-[#3ddc84]/10 transition-all">✊ I BRING PEOPLE — SHOW ME THE MECHANISM</Link>
          </div>
        </section>
      </main>
      ...
      <style jsx global>{`
        ...
        .eyebrow { font-family: 'Barlow Condensed', sans-serif; font-weight: 700; font-size: 0.85rem; letter-spacing: 0.15em; color: #3ddc84; text-transform: uppercase; display: block; margin-bottom: 12px; }
      `}</style>
    </>
  )
}

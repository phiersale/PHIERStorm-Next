  ...
  return (
    <>
      ...
      <main className="pt-24 pb-16">
        ...
        {/* ⭐ BEGIN: AUDIENCE FORK (DARK THEME) ⭐ */}
        ...
        {/* ⭐ BEGIN: HOMEPAGE CLARITY BLOCK (DARK THEME) ⭐ */}
        ...
        <section className="px-4 py-16 max-w-[760px] mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex gap-5 items-start">
              ...
              <div>
                <div className="font-condensed font-bold text-xl text-white mb-1">People sign</div>
                <div className="text-gray-400">Adding your name isn't symbolic. It's how we organize pressure.</div>
              </div>
            </div>
            <div className="flex gap-5 items-start">
              ...
              <div>
                <div className="font-condensed font-bold text-xl text-white mb-1">We coordinate by district</div>
                <div className="text-gray-400">Real people. Real numbers. Tied to the representatives who have to respond.</div>
              </div>
            </div>
            <div className="flex gap-5 items-start">
              ...
              <div>
                <div className="font-condensed font-bold text-xl text-white mb-1">Pressure becomes unavoidable</div>
                <div className="text-gray-400">When enough people act together, ignoring them becomes more dangerous than responding.</div>
              </div>
            </div>
            <div className="flex gap-5 items-start">
              ...
              <div>
                <div className="font-condensed font-bold text-xl text-red-500 mb-1">Congress responds — or gets replaced</div>
                <div className="text-gray-400">That's how leverage works.</div>
              </div>
            </div>
          </div>
        ...
        {/* ═══════════════════════════════════════
             SECTION 6 — WHAT SIGNING ACTUALLY DOES
        ═══════════════════════════════════════ */}
        <section className="px-4 py-16 text-center">
        ...
        {/* ═══════════════════════════════════════
             SECTION 8 — THREE KINDS OF POWER GRID
        ═══════════════════════════════════════ */}
        <section className="px-4 py-16 bg-[#0a1628] border-y border-[#3ddc84]/10">
        ...
        {/* ═══════════════════════════════════════
             SECTION — YOU'RE ALREADY PART OF THIS
        ═══════════════════════════════════════ */}
        <section className="px-4 py-16 text-center">
      ...
      <footer className="text-center py-12 px-6 border-t border-[#3ddc84]/10 bg-[#0d1525]">
        <Image src="/images/PHIERS_Logo.jpg" alt="PHIERS.org" width={80} height={80} className="mx-auto mb-4 opacity-70" />

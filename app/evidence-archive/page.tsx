            ...
            <div className="mt-4 p-5 bg-[#0a1628]/20 rounded-lg">
              <div className="bg-[#0a1628]/40 rounded-lg p-5 border border-gray-800">
                <div className="space-y-4 text-gray-300 text-sm">
                  ...
                  <div><p className="text-green font-semibold">2007 – 2018 — U.S. Department of Veterans Affairs (multiple assignments)</p><p className="text-gray-400 text-xs ml-4">Business Analyst → Senior Business Analyst, Registration, Eligibility & Enrollment Systems Group. One of five civilians selected for the VA's Enterprise‑wide reengineering initiative.</p></div>
            ...
            <div className="mt-4 p-5 bg-[#0a1628]/20 rounded-lg">
              <div className="bg-[#0a1628]/40 rounded-lg p-5 border border-gray-800">
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 justify-items-center">
                  ...
                  <div className="w-full max-w-[110px] relative"><div className="absolute top-0 right-0 z-10 bg-black/70 text-green-300 text-[8px] px-1 rounded">2015</div><div className="relative pb-[56.25%] bg-black/40 rounded-lg mt-4"><img src="https://img.youtube.com/vi/HuTot2fng0k/mqdefault.jpg" className="absolute inset-0 w-full h-full object-cover" /></div><p className="text-[10px] text-center mt-1">Patriot Medical Transport Partnership</p><p className="text-center text-[8px]"><a href="https://www.youtube.com/watch?v=HuTot2fng0k" target="_blank" className="text-green-500/70">Watch on YouTube →</a></p></div>

...
// VERSION: 3.0 - All sections collapsed by default (accordion style)
  ...
  return (
    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="sticky-header-offset max-w-5xl mx-auto px-4 pt-24 pb-16">
        ...
        {/* COMING SOON MESSAGE - CHECK BACK OFTEN */}
        ...
        {/* ========== HEALTHCARE - COLLAPSIBLE ========== */}
        <section id="healthcare" className="mb-8 scroll-mt-24">
          <button
            onClick={() => toggleSection('healthcare')}
            className="w-full text-left flex justify-between items-center p-4 bg-[#0a1628]/60 border border-green/20 rounded-lg hover:border-green/40 transition"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-green">Healthcare</h2>
        ...
        {/* ========== CONGRESSIONAL LEVERAGE - COLLAPSIBLE ========== */}
        <section id="congressional" className="mb-8 scroll-mt-24">
          <button
            onClick={() => toggleSection('congressional')}
            className="w-full text-left flex justify-between items-center p-4 bg-[#0a1628]/60 border border-green/20 rounded-lg hover:border-green/40 transition"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-green">Congressional Leverage</h2>
          ...
          {expandedSection === 'congressional' && (
            <div className="mt-4 space-y-6 p-5 bg-[#0a1628]/20 rounded-lg">
              ...
              <div className="bg-[#0a1628]/40 rounded-lg p-5 border border-gray-800">
                <button
                  onClick={() => toggleSection('district-outcomes')}
                  className="w-full text-left flex justify-between items-center text-white font-semibold text-lg"
                >
                  <span>🎯 District Outcomes — The Power of Being Counted</span>
                  <span className="text-green">{expandedSection === 'district-outcomes' ? '−' : '+'}</span>
                </button>
                {expandedSection === 'district-outcomes' && (
                  <div className="mt-4 space-y-4 text-gray-300 text-sm">
                    ...
                    <p className="text-green-300 text-xs font-semibold">
                      ...
                      constituents can force Congress to show up, answer questions, and act.
                    </p>
        ...
        {/* ========== PROFESSIONAL HISTORY - COLLAPSIBLE ========== */}
        <section id="professional-history" className="mb-8 scroll-mt-24">
          <button
            onClick={() => toggleSection('professional-history')}
            className="w-full text-left flex justify-between items-center p-4 bg-[#0a1628]/60 border border-green/20 rounded-lg hover:border-green/40 transition"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-green">Professional History</h2>
        ...
        {/* ========== PUBLIC HEALTH - COLLAPSIBLE ========== */}
        <section id="public-health" className="mb-8 scroll-mt-24">
          <button
            onClick={() => toggleSection('public-health')}
            className="w-full text-left flex justify-between items-center p-4 bg-[#0a1628]/60 border border-green/20 rounded-lg hover:border-green/40 transition"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-green">Public Health</h2>
        ...
        {/* ========== ARCHIVED WEBSITES - COLLAPSIBLE ========== */}
        <section id="archived-websites" className="mb-8 scroll-mt-24">
          <button
            onClick={() => toggleSection('archived-websites')}
            className="w-full text-left flex justify-between items-center p-4 bg-[#0a1628]/60 border border-green/20 rounded-lg hover:border-green/40 transition"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-green">Archived Websites</h2>
        ...
        {/* ========== VIDEO ARCHIVE - COLLAPSIBLE ========== */}
        <section id="video-archive" className="mb-8 scroll-mt-24">
          <button
            onClick={() => toggleSection('video-archive')}
            className="w-full text-left flex justify-between items-center p-4 bg-[#0a1628]/60 border border-green/20 rounded-lg hover:border-green/40 transition"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-green">Video Archive</h2>
        ...
        {/* ========== EMPLOYMENT & RESOURCES - COLLAPSIBLE ========== */}
        <section id="employment" className="mb-16 scroll-mt-24">
          <button
            onClick={() => toggleSection('employment')}
            className="w-full text-left flex justify-between items-center p-4 bg-[#0a1628]/60 border border-green/20 rounded-lg hover:border-green/40 transition"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-green">Employment & Resources</h2>

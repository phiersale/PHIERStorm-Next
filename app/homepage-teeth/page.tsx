  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Onion Rings Diagram */}
        <section className="bg-bg-deep section">
          <div className="container text-center">
            ...
            {/* Detail Panel */}
            <div
              className={`w-[min(600px,92vw)] min-h-[140px] bg-bg-dark/95 rounded-xl p-6 mx-auto transition-all duration-300 border-l-4 ${detailPanelVisible && activeRing !== null ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}
        ...
        <section className="container section text-center">
          <div className="video-container mx-auto">
            <div id="wrap-leverage-teeth" className="video-wrapper cursor-pointer group" onClick={() => playVideo('leverage-teeth', 'https://www.youtube.com/embed/wnSy5jjxAac?autoplay=1&rel=0')}>
        ...
        <section className="container section" id="how-it-works">
          ...
          <div className="space-y-5 max-w-[600px] mx-auto">
            <div className="flex gap-4">
              <div className="step-num w-11 h-11 rounded-full bg-green text-bg-deep flex items-center justify-center font-condensed font-black text-xl flex-shrink-0">1</div>
              <div><p className="font-condensed font-bold text-xl text-white mb-1">You add your name</p><p className="text-body text-sm">Not symbolic. Not a petition that disappears. It's how real people are counted — by district.</p></div>
            </div>
            <div className="flex gap-4">
              <div className="step-num w-11 h-11 rounded-full bg-green text-bg-deep flex items-center justify-center font-condensed font-black text-xl flex-shrink-0">2</div>
              <div><p className="font-condensed font-bold text-xl text-white mb-1">We organize by district</p><p className="text-body text-sm">Your name becomes part of a coordinated pressure block tied directly to your representative — based on what people in your district actually want.</p></div>
            </div>
            <div className="flex gap-4">
              <div className="step-num w-11 h-11 rounded-full bg-green text-bg-deep flex items-center justify-center font-condensed font-black text-xl flex-shrink-0">3</div>
              <div><p className="font-condensed font-bold text-xl text-white mb-1">When enough people are organized</p><p className="text-body text-sm">The pressure becomes public and visible inside the district — creating a moment where your representative has to respond, in front of the people they represent.</p></div>
            </div>
            <div className="flex gap-4">
              <div className="step-num w-11 h-11 rounded-full bg-red text-white flex items-center justify-center font-condensed font-black text-xl flex-shrink-0">4</div>
              <div><p className="font-condensed font-bold text-xl text-red-500 mb-1">And when leaders ignore it</p><p className="text-body text-sm">They either respond — or they have to explain why they won't, publicly, on the record.</p></div>
            </div>
          </div>

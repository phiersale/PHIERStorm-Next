...
// HOMEPAGE TEETH PAGE - Complete with design system
...
export default function HomepageTeethPage() {
  ...
  useEffect(() => {
    // Auto-open ring 0 after page loads
    setTimeout(() => {
      setActiveRing(0)
    ...
    <>
      ...
      <main>
        ...
        <section className="bg-[#080d1a] py-12 px-6 text-center">
            ...
            {[0, 1, 2, 3, 4, 5].map((ringIdx) => {
              ...
              return (
                <div
                  ...
                  className={`absolute rounded-full transition-all duration-300 hover:scale-105 ${
                    activeRing === ringIdx ? 'scale-105 brightness-125' : ''
                  } ${ringIdx === 0 ? 'animate-[firePulse_2.5s_ease-in-out_infinite]' : ''}`}
                  style={{
                    inset: `${insets[ringIdx]}%`,
                    border: `2px solid ${colors[ringIdx]}`,
                    background: `radial-gradient(ellipse at center, transparent 0%, ${bgColors[ringIdx]} 100%)`,
                    boxShadow: ringIdx === 0 
                      ? '0 0 40px rgba(230,57,70,0.25), inset 0 0 40px rgba(230,57,70,0.08)'
                      : `0 0 ${20 - ringIdx * 4}px ${colors[ringIdx]}25`,
                  }}
                />
              )
            })}
          ...
          {/* Detail Panel */}
          <div
            className={`w-[min(600px,92vw)] min-h-[140px] bg-bg-dark/95 rounded-xl p-6 mx-auto transition-all duration-300 border-l-4 ${
              detailVisible && activeRing !== null ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'
            }`}
        ...
        <section className="container section text-center py-5">
          <div className="max-w-[600px] mx-auto">
            <Image
              ...
              width={600}
              height={400}
              className="w-full h-auto rounded-xl border border-red-500/30"
            />
          </div>
        </section>
        ...
        <section className="container section text-center py-5">
          <div className="max-w-[500px] mx-auto">
            <Image
              ...
              alt="PHIERStorm — The Power Behind the Movement"
              width={500}
              height={300}
        ...
        <section className="container section" id="how-it-works">
          ...
          <div className="space-y-5 max-w-[600px] mx-auto">
            <div className="flex gap-4">
              <div className="w-11 h-11 rounded-full bg-green text-bg-deep flex items-center justify-center font-condensed font-black text-xl flex-shrink-0">1</div>
              <div>
                <p className="font-condensed font-bold text-xl text-white mb-1">You add your name</p>
                <p className="text-body text-sm">Not symbolic. Not a petition that disappears. It's how real people are counted — by district.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-11 h-11 rounded-full bg-green text-bg-deep flex items-center justify-center font-condensed font-black text-xl flex-shrink-0">2</div>
              <div>
                <p className="font-condensed font-bold text-xl text-white mb-1">We organize by district</p>
                <p className="text-body text-sm">Your name becomes part of a coordinated pressure block tied directly to your representative — based on what people in your district actually want.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-11 h-11 rounded-full bg-green text-bg-deep flex items-center justify-center font-condensed font-black text-xl flex-shrink-0">3</div>
              <div>
                <p className="font-condensed font-bold text-xl text-white mb-1">When enough people are organized</p>
                <p className="text-body text-sm">The pressure becomes public and visible inside the district — creating a moment where your representative has to respond, in front of the people they represent.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-11 h-11 rounded-full bg-red text-white flex items-center justify-center font-condensed font-black text-xl flex-shrink-0">4</div>
              <div>
                <p className="font-condensed font-bold text-xl text-red-500 mb-1">And when leaders ignore it</p>
                <p className="text-body text-sm">They either respond — or they have to explain why they won't, publicly, on the record.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-6">
            <Button href="/petition" variant="secondary">✍ Add Your Name →</Button>
        ...
        {/* CREDIBILITY BRIDGE */}
        <section className="container section text-center pb-0">
        ...
        <section className="container section">
          <div className="max-w-[760px] mx-auto text-center mb-6">
            ...
            <div className="text-center my-4">
              <Button href="/petition" variant="secondary">✍ Add Your Name — Help Make Congress Do Its Job</Button>
            </div>
          ...
          <div className="video-container max-w-[800px] mx-auto">
            ...
            <div className="bg-bg-card p-4 border-x border-b border-green/20 rounded-b-xl text-center">
              <div className="font-display text-xl text-green mb-1">🎥 How Pressure Builds — And Why Congress Can't Ignore It</div>
              <div className="font-condensed text-gray-400 text-sm">Why Congress can't ignore organized people — and what happens when pressure builds in one place.</div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-bg-dark border-y border-green/10 section">
          <div className="container text-center">
            <span className="font-condensed font-bold text-green text-sm uppercase tracking-wider block mb-3">The Tipping Point Is Smaller Than You Think</span>
            <h2 className="font-display text-3xl md:text-4xl text-white mb-3">Around 3.5% — organized and sustained — is enough to tip the balance.</h2>
            <p className="text-body mb-3">The most successful nonviolent movements in modern history crossed this threshold.</p>
            <p className="text-body mb-3">It doesn't take everyone.<br />Just enough people, acting together in the same place.</p>
            <p className="font-condensed font-bold text-2xl text-green my-3">12 million Americans. That's the line.</p>
            ...
            <div className="max-w-[380px] mx-auto mt-6">
              <div onClick={() => setChenowethModalOpen(true)} className="cursor-pointer">
                <Image
                  src="/images/3.5pct_Erica_Chenoweth.jpg"
                  alt="3.5% — Chenoweth Research"
                  width={380}
                  height={250}
                  className="rounded-lg border border-white/10 hover:scale-[1.02] transition-transform mx-auto"
                />
              </div>
        ...
        {/* TRANSITION → THE-TEETH */}
        <section className="container section text-center py-12">
          <div className="max-w-[560px] mx-auto">
            <p className="font-condensed font-bold text-xl text-white mb-2">You understand the problem. Now see the power.</p>
            <p className="text-gray-400 text-base mb-4">The energy is real. The anger is justified. Here's what we do with it.</p>
            <Button href="/the-teeth" variant="secondary">See What Makes This Unavoidable →</Button>
        ...
        {/* GO DEEPER */}
        <section className="container section max-w-[640px] mx-auto">
          <p className="font-condensed font-bold text-green text-sm uppercase tracking-wider block mb-3">Go Deeper</p>
          <p className="text-gray-400 mb-6">Choose the path you want to understand first.</p>
          ...
          <div className="mb-6">
            ...
            <Link href="/leverage" className="font-condensed font-bold text-green no-underline border-b border-green/30 pb-0.5 hover:border-green">Show me the Leverage →</Link>
          </div>
          ...
          <div>
            ...
            <Link href="/full-story" className="font-condensed font-bold text-green no-underline border-b border-green/30 pb-0.5 hover:border-green">Explore the Deep Dive →</Link>
          </div>
        </section>
        ...
        {/* Closing Statement */}
        <section className="container section text-center pt-12">
      ...
      {/* Chenoweth Modal */}
      {chenowethModalOpen && (
        <div className="fixed inset-0 bg-black/90 z-[99999] flex items-center justify-center p-4" onClick={() => setChenowethModalOpen(false)}>
          <div className="relative max-w-[90vw] max-h-[85vh]" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => setChenowethModalOpen(false)}
      ...
      <style jsx global>{`
        @keyframes firePulse {
          0%, 100% { 
            box-shadow: 0 0 40px rgba(230,57,70,0.25), inset 0 0 40px rgba(230,57,70,0.08);
          }
          50% { 
            box-shadow: 0 0 70px rgba(230,57,70,0.45), inset 0 0 60px rgba(230,57,70,0.15);
          }
        }
        .animate-\[firePulse_2.5s_ease-in-out_infinite\] {
...
// END FILE: app/homepage-teeth/page.tsx

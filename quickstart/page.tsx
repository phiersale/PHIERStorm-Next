  ...
  return (
    <>
      ...
      <main className="pt-20 pb-16 max-w-[900px] mx-auto px-6">
        ...
        <div className="bg-[#111d35]/90 border-l-4 border-[#3ddc84] rounded-r-lg p-6 md:p-8 my-8">
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-5">
            <div className="bg-red-500/10 border-2 border-red-500/30 rounded-lg p-5">
              <h3 className="font-condensed text-xl text-red-400 mb-3">Status Quo Insurance ($10K)</h3>
              <ul className="space-y-2 text-red-200 list-disc pl-4">
            ...
            <div className="bg-[#3ddc84]/10 border-2 border-[#3ddc84] rounded-lg p-5">
              <h3 className="font-condensed text-xl text-[#3ddc84] mb-3">PHIERS Telehealth ($600)</h3>
              <ul className="space-y-2 text-green-200 list-disc pl-4">
          ...
          <div className="bg-[#3ddc84]/15 p-4 rounded-lg">
            <p className="text-white"><strong className="text-[#3ddc84]">Important:</strong> Telehealth isn't a replacement for insurance — it completes what insurance leaves undone. For the 80% who don't need hospitalization, $600/year telehealth provides the care they need.</p>
          </div>
          <div className="bg-[#3ddc84]/10 border border-[#3ddc84] rounded-lg p-5 mt-5 text-center">
            ...
            <p className="text-[#3ddc84] text-xl font-bold">Exponential. Unstoppable. Universal healthcare in 90 days to critical mass.</p>
          </div>
        </div>
        ...
        <div className="bg-[#3ddc84]/10 border-l-4 border-[#3ddc84] rounded-r-lg p-6 my-8">
          <h3 className="font-condensed text-xl text-[#3ddc84] mb-2">Prescription Drug Strategy</h3>
        ...
        <div className="bg-[#111d35]/90 border-l-4 border-[#3ddc84] rounded-r-lg p-6 md:p-8 my-8">
          ...
          <div className="space-y-5">
            <div className="border border-[#3ddc84]/30 rounded-lg p-5">
              <div className="inline-block w-8 h-8 bg-[#3ddc84] text-[#080d1a] rounded-full text-center leading-8 font-bold mr-2">1</div>
              <h3 className="inline font-condensed text-lg text-[#3ddc84]">Sign the Petition (30 seconds)</h3>
              <p className="text-gray-300 mt-3 ml-10">Add your name to force Congress to hold mandatory town halls. 1,500 signatures per district = they must face you.</p>
              <div className="mt-4 ml-10"><Link href="/petition" className="inline-block px-5 py-2 bg-red-600 text-white font-condensed font-bold rounded-lg hover:bg-red-700 transition-all">✍ Sign the Petition</Link></div>
            </div>
            <div className="border border-[#3ddc84]/30 rounded-lg p-5">
              <div className="inline-block w-8 h-8 bg-[#3ddc84] text-[#080d1a] rounded-full text-center leading-8 font-bold mr-2">2</div>
              <h3 className="inline font-condensed text-lg text-[#3ddc84]">Share the Cascade (2 minutes)</h3>
              <p className="text-gray-300 mt-3 ml-10">Every share reaches 10-100 more people. Each person who signs multiplies the pressure. This is exponential leverage.</p>
            </div>
            <div className="border border-[#3ddc84]/30 rounded-lg p-5">
              <div className="inline-block w-8 h-8 bg-[#3ddc84] text-[#080d1a] rounded-full text-center leading-8 font-bold mr-2">3</div>
              <h3 className="inline font-condensed text-lg text-[#3ddc84]">Watch It Spread (Exponential)</h3>
              <p className="text-gray-300 mt-3 ml-10">1 person → 12 people → 148 people → millions. The cascade can't be stopped once it starts. That's the power of mechanical leverage.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#111d35]/90 border-l-4 border-[#3ddc84] rounded-r-lg p-6 md:p-8 my-8">
          ...
          <div className="text-center my-6">
            <button onClick={() => openModal('/images/PHIERS_Cascade_Leverage_Visual_v1.png')} className="cursor-pointer">
              <Image src="/images/PHIERS_Cascade_Leverage_Visual_v1.png" alt="PHIERS Cascade Leverage Visual" width={500} height={300} className="max-w-full h-auto mx-auto rounded-lg border-2 border-[#3ddc84]/30 hover:scale-[1.01] transition-transform" />
            </button>
            <p className="text-gray-500 text-sm italic mt-2">This is how the system works when we connect the pieces — Click for full breakdown</p>
          </div>
          ...
          <div className="text-center my-6">
            <button onClick={() => openModal('/images/SIMPLE_MATH_Pyramid_Universal_Coverage.png')} className="cursor-pointer">
              <Image src="/images/SIMPLE_MATH_Pyramid_Universal_Coverage.png" alt="Universal Coverage Pyramid" width={500} height={300} className="max-w-full h-auto mx-auto rounded-lg border-2 border-[#3ddc84]/30 hover:scale-[1.01] transition-transform" />
            </button>
            <p className="text-gray-500 text-sm italic mt-2">Medicaid → Medicare → ACA → 234M Americans Covered — Click to see the progression</p>
          </div>
        ...
        <div className="bg-[#3ddc84]/10 border-2 border-[#3ddc84] rounded-xl p-8 text-center my-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/solutions" className="px-6 py-3 bg-[#3ddc84] text-[#080d1a] font-condensed font-bold rounded-lg hover:bg-[#34c474] transition-all">See 5D Solutions</Link>
            <Link href="/overview#how-it-works" className="px-6 py-3 bg-transparent text-[#3ddc84] border border-[#3ddc84] rounded-lg font-condensed font-bold hover:bg-[#3ddc84]/10 transition-all">How It Works</Link>
            <Link href="/crisis" className="px-6 py-3 bg-transparent text-[#3ddc84] border border-[#3ddc84] rounded-lg font-condensed font-bold hover:bg-[#3ddc84]/10 transition-all">The Crisis</Link>
          </div>
        </div>
      </main>

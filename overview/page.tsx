      ...
      <main className="pt-20 pb-16 max-w-[1000px] mx-auto px-6">
        ...
        <section className="bg-[#111d35]/90 border-l-4 border-[#3ddc84] rounded-r-lg p-6 md:p-8 mb-8">
          ...
          <div className="bg-[#3ddc84]/10 border border-[#3ddc84] rounded-lg p-5 mt-4">
            ...
            <ul className="space-y-2 text-gray-300 list-disc pl-5"><li>Your name is counted by congressional district</li><li>District participation builds measurable political leverage</li><li>Leverage escalates publicly toward key milestones</li><li>Power responds when pressure becomes unavoidable</li></ul>
        ...
        <section className="bg-[#111d35]/90 border-l-4 border-[#3ddc84] rounded-r-lg p-6 md:p-8 mb-8">
          ...
          <div className="bg-[#3ddc84]/10 border border-[#3ddc84] rounded-lg p-5 mb-4"><h3 className="font-condensed text-lg text-[#ffa726] mb-2">March 28, 2026 — No Kings Rally</h3><p><strong className="text-white">3.5% participation = 11.6 million signatures</strong><br />We bring organized citizen leverage to a national moment of visibility and accountability.</p><p className="mt-3 text-gray-400">What happens before March 28 determines what power must respond to after.</p></div>
          <div className="bg-[#3ddc84]/10 border border-[#3ddc84] rounded-lg p-5"><h3 className="font-condensed text-lg text-[#3ddc84] mb-2">July 4, 2026 — Economic Independence Day</h3><p><strong className="text-white">100 Million Americans coordinated</strong><br />Independence Day becomes the day we declare economic independence from corporate control.</p><p className="mt-3 text-gray-400">When 100 million Americans coordinate around healthcare reform, Congress has no choice but to act.</p></div>
        </section>

        {/* Strategy Section */}
        <section className="bg-[#111d35]/90 border-l-4 border-[#3ddc84] rounded-r-lg p-6 md:p-8 mb-8">
          <h2 className="font-display text-2xl md:text-3xl text-[#3ddc84] mb-4">The PHIERS Strategy — At a Glance</h2>
          <h3 className="font-condensed text-lg text-white mt-4 mb-2">Critical Mass</h3><p className="text-gray-300 mb-3">3.5% participation has repeatedly triggered systemic change across history — from civil rights movements to democratic transitions worldwide.</p>
          <h3 className="font-condensed text-lg text-white mt-4 mb-2">District-Level Pressure</h3><p className="text-gray-300 mb-3">Members of Congress don't fear "the nation." They fear their own district. PHIERS applies pressure locally, where representatives are most vulnerable.</p>
          <h3 className="font-condensed text-lg text-white mt-4 mb-2">Replacement Threat</h3><p className="text-gray-300 mb-3">When enough voters in a district coordinate around a single demand, incumbents move — or lose. We help recruit and support replacements who will act.</p>
          <h3 className="font-condensed text-lg text-white mt-4 mb-2">Existing Law</h3><p className="text-gray-300 mb-3">We're not waiting for a miracle bill. We're using authority that already exists under the ACA to force telehealth coverage.</p>
          <h3 className="font-condensed text-lg text-white mt-4 mb-2">The Math Works</h3><p className="text-gray-300"><strong className="text-[#3ddc84]">$600 per person per year</strong> via telehealth covers 80% of healthcare needs for 234 million Americans — without new taxes and without killing private insurance.</p>
        </section>
        ...
        <section id="how-it-works" className="bg-[#111d35]/90 border-l-4 border-[#3ddc84] rounded-r-lg p-6 md:p-8 mb-8">
          ...
          <h3 className="font-condensed text-lg text-white mt-4 mb-2">The Exponential Mechanism</h3><p className="text-gray-300 mb-4">Congress allows telehealth through the ACA exchange immediately. One person's $600 annual savings funds 12 others. Those 12 fund 148. Exponential. Unstoppable.</p>
          <div className="bg-[#3ddc84]/10 border border-[#3ddc84] rounded-lg p-5"><h3 className="font-condensed text-lg text-white mb-3">The Nine Iterations to 234 Million</h3><ol className="space-y-1 text-gray-300 list-decimal pl-5"><li>Iteration 1: 1 → 12 (12 people covered)</li><li>Iteration 2: 12 → 148 (148 people covered)</li><li>Iteration 3: 148 → 1,825 (1,825 people covered)</li><li>Iteration 4: 1,825 → 22,500 (22,500 people covered)</li><li>Iteration 5: 22,500 → 277K (277,000 people covered)</li><li>Iteration 6: 277K → 3.4M (3.4 million people covered)</li><li>Iteration 7: 3.4M → 42M (42 million people covered)</li><li>Iteration 8: 42M → 520M (full U.S. population exceeded)</li><li>Iteration 9: Mathematical overshoot proves universal coverage capacity</li></ol><p className="text-center text-[#3ddc84] font-bold mt-4">Each iteration takes 1-3 months. Full cascade: 9-27 months to universal coverage.</p></div>
          <h3 className="font-condensed text-lg text-white mt-4 mb-2">The 3.5% Rule</h3><p className="text-gray-300 mb-2">Harvard researcher Erica Chenoweth's research shows that when 3.5% of a population actively engages in sustained nonviolent resistance, success becomes inevitable.</p><p className="text-gray-300">For the United States, 3.5% = <strong className="text-[#3ddc84]">11.6 million people</strong>. PHIERS is building toward that critical mass by March 28, 2026.</p>
        </section>
        ...
        <section className="bg-[#111d35]/90 border-l-4 border-[#3ddc84] rounded-r-lg p-6 md:p-8 mb-8">
          ...
          <ol className="space-y-2 text-gray-300 list-decimal pl-5 mb-4"><li><strong className="text-white">Step 1:</strong> You join the First Wave with your district information or zip code</li><li><strong className="text-white">Step 2:</strong> Your district is added to the PHIERS pressure map</li><li><strong className="text-white">Step 3:</strong> When enough people in your district sign, we trigger local escalation: coordinated calls, media pressure, and candidate commitments</li><li><strong className="text-white">Step 4:</strong> If your member of Congress refuses to move, we help recruit and support a replacement who will</li></ol>
          <div className="bg-[#3ddc84]/10 border border-[#3ddc84] rounded-lg p-5 text-center"><p className="text-gray-300"><strong className="text-white">No spam. No selling. No gimmicks.</strong><br />Just organized citizens building real leverage.</p></div>
        </section>
        ...
        <section className="bg-[#111d35]/90 border-l-4 border-[#3ddc84] rounded-r-lg p-6 md:p-8 mb-8">
          ...
          <h3 className="font-condensed text-lg text-white mt-4 mb-2">What PHIERS Is</h3><ul className="list-disc pl-5 text-gray-300 mb-4"><li>A public-interest movement</li><li>Citizen-driven and non-corporate</li><li>Strategy-based, not vibes-based</li><li>Built for accountability</li></ul>
          <h3 className="font-condensed text-lg text-white mt-4 mb-2">What PHIERS Is NOT</h3><ul className="list-disc pl-5 text-gray-300"><li>A company</li><li>An insurance product</li><li>A political party</li><li>A fundraising scheme</li></ul>
        </section>
